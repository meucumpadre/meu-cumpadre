...
changelog-v1_3: |
  ...
  - Router-Ethics v11.0 → v11.0 (140 nós, 7 hooks, Hook 1b IVCAD-MC refatorado) em Princípio 5, E1, referências
  ...
  - PATCH 09/05/2026: Hook 0 gov.br adicionado pré-E1 (ERRATA-001 · MC-GOVBR-ArvoreDecisao-APIHumana-v1_1) · Rota D separada de Bloqueio Antifraude na tabela E1
changelog-v1_3_1: "Patch cirúrgico 09/05/2026: TENV-MC em §4.1, estrutura valor BF confirmada (Sprint B3) em §2.0.1, nota MTE Seguro-Defeso em §2.0.3"
---
...
**Estrutura de valor BF confirmada (Lei 14.601/2023 art. 7º + Sprint B3):** R$142/integrante (Renda de Cidadania) + piso R$600/família (Complementar) + R$150/criança 0-7 anos (Primeira Infância) + R$50/integrante elegível — gestante, nutriz, criança 7-18 anos (Variável Familiar). Valores cumulativos por família. Pé-de-Meia (estudante EM público 14-24 anos, família CadÚnico): até R$9.200 em 3 anos — **NÃO compõe renda familiar** para outros benefícios (Lei 14.818 art. 3º §2º). *(NOVO v1.3.1)*
...
> **⚠️ Atenção operacional (Sprint B3, 07/05/2026):** desde a MP 1.323/2025 (consolidada pela Lei 15.265/2025), o Seguro-Defeso é requerido no **MTE — Ministério do Trabalho e Emprego**, não mais no INSS. O Decreto 8.424/2015 ainda traz redação antiga (INSS) — risco de fricção operacional confirmado. Direcionar requerimentos novos ao MTE, não ao 135 do INSS. *(NOVO v1.3.1)*
...
#### 🔒 Hook 0 — Verificação de Nível gov.br (PRÉ-CONDIÇÃO OBRIGATÓRIA)

**Status:** operacional desde 09/05/2026.
**Regra:** executa ANTES de qualquer nó do pipeline E1-E7. Sem nível Prata mínimo confirmado, os nós V91-V140 (Viabilidade/CNIS) não disparam.

**O que é:** 5 perguntas WhatsApp (P1-P5) classificam o nível atual da conta gov.br do cidadão e definem a rota de elevação.

| Pergunta | O que detecta |
|----------|--------------|
| P1 — Já trabalhou com carteira assinada? | Inteligência contributiva disponível |
| P2 — Tem CTPS física em casa? | Documento comprobatório disponível |
| P3 — Tem papel do INSS (extrato/comprovante) em casa? | CNIS físico disponível |
| P4 — Lembra onde e quando trabalhou? | Memória como fonte |
| P5 — Recebe algum benefício hoje? | Benefício ativo como âncora |

**Hierarquia de rotas (ERRATA-001, 09/05/2026 — DEFINITIVA):**

1. **Rota 1 — Biometria facial** (50-60% do funil) — rota principal. MC envia vídeo institucional + orienta liveness.
2. **Rota 2 — Banco credenciado** (25-30%) — fallback bancarizados (Caixa, BB, Bradesco, Itaú, Santander, Sicoob).
3. **Rota 3 — Presencial** (10-15%) — balcão INSS / agência bancária / posto CIN. Último recurso de elevação.
4. **KBA diagnóstico** — NÃO é rota de elevação. Acionar SOMENTE quando 1-2-3 falharam. Concede Bronze validado (não Prata). Uso: obter metadados CNIS para iniciar triagem Φ₁ enquanto aguarda solução presencial.

**Posição ética (INVIOLÁVEL):**
- Cenário A (preparação remota — MC orienta, cidadão opera própria conta): ✅ APROVADO
- Cenário A+ (videochamada assistida com consentimento gravado): ✅ APROVADO
- Cenário B (MC opera conta do cidadão com senha em custódia): ❌ VETADO — Lei 14.063/2020 art. 6º

**Proibições absolutas:**
- ❌ Posicionar KBA como rota de elevação para Prata
- ❌ Acionar KBA como primeira opção na triagem
- ❌ Responder questionário KBA pelo cidadão ('soprando resposta' = Cenário B disfarçado)
- ❌ Prometer que biometria facial funciona na primeira tentativa (taxa de falha estimada 40-50%)

**Caso empírico validado — JAN001 (09/05/2026):** Bronze → Ouro via biometria facial na 2ª tentativa após assistir vídeo de orientação MC. Cooldown KBA 24h confirmado empiricamente.

**Canônico:** `MC-GOVBR-ArvoreDecisao-APIHumana-v1_1-2026-0509.md`
...
| Qualquer | Qualquer | Alto | **Bloqueio Antifraude** — nó Compliance (C46-C90) — investigação antes de prosseguir |
| IPH ≥ 0,25 · risco de vida · violência | Qualquer | Qualquer | **Rota D** — Interrupção Dignidade (3-5%) — rede de proteção |
...
| TENV-MC (Taxa de Elevação de Nível gov.br) | medir desde caso #1 | Hook 0 WhatsApp — % cidadãos que precisaram elevar conta gov.br antes de E1 *(NOVO v1.3.1)* |
...
## Links canônicos
[[CLAUDE]] · [[_MC-RouterEthics_11_v1_1-2026-0505-CLevel]] · [[MC-ADR-007-CampoPrecificacao-v3_8-ADDENDUM-2026-0507]] · [[MC-ADR-009b-TresEstados-Custodia-Dossie-v1_0-2026-0417]]
