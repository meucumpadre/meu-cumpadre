...
> [!info] RESOLVIDO 2026-05-13 ~22:30 UTC
> Numeração final: **#24**. Arquivo canônico ativo: `MC-PRINCIPIO-024-DocumentacaoCanonicaUnificada-v1_0-2026-0513.md` nesta mesma pasta.
> Este arquivo PENDENTE é mantido como histórico de governança da colisão. Não operar a partir dele.
