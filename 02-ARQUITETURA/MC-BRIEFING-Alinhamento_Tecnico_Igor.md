...
## 1. De "Agência" a "Escritório Melo": o dicionário de tradução
...
|---|---|---|
| **Entidade "Agência"** | Escritório Melo Advogados Associados (Dra. Juliana Pereira de Melo) | Parceiro B2B com ~95% de exclusividade. Na modelagem, é a entidade `Partner` — possui CNPJ, inscrição OAB, configura checklists por espécie de benefício e visualiza casos atribuídos. |
...
O Meu Cumpadre (CNPJ 6201-5/01, atividade-meio) presta **infraestrutura tecnológica** ao Escritório Melo. A Dra. Juliana (OAB, atividade-fim) é responsável por todo o contencioso: peticionamento, audiências, pareceres, estratégia processual. O cidadão (Dona Zilda) chega via WhatsApp, é atendido pela plataforma MC na coleta e triagem, e quando entra no pipeline jurídico passa a ser cliente do escritório Melo — não do MC.
...
- Multi-escritório (MVP atende apenas Escritório Melo)
